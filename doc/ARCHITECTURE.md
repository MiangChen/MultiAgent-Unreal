...
| `MASTTask_Charge` | 自动充电 | ChargingStationTag, AcceptanceRadius |
| `MASTTask_Coverage` | 区域覆盖扫描 | CoverageAreaTag, AcceptanceRadius, bLoopOnComplete |
| `MASTTask_Follow` | 跟随目标 | TargetActorTag, FollowDistance |
