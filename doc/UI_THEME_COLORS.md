...
| 变量名 | 默认值 | 用途 |
|--------|--------|------|
| `PrimaryColor` | 蓝色 (0.2, 0.6, 1.0) | 主要按钮、强调元素、链接 |
| `SecondaryColor` | 深灰 (0.3, 0.3, 0.35) | 次要按钮、边框、分隔线 |
| `DangerColor` | 红色 (1.0, 0.3, 0.3) | 危险操作、错误提示、删除按钮 |
| `SuccessColor` | 绿色 (0.3, 0.8, 0.4) | 成功提示、确认操作、完成状态 |
| `WarningColor` | 黄色 (1.0, 0.8, 0.2) | 警告提示、注意事项 |
| `BackgroundColor` | 深色半透明 (0.1, 0.1, 0.12, 0.95) | 面板背景、模态窗口背景 |
| `TextColor` | 黑色 (0.05, 0.05, 0.05) | 主要文字颜色 |
...
| 变量名 | 默认值 | 用途 |
|--------|--------|------|
| `SecondaryTextColor` | 灰色 (0.6, 0.6, 0.6) | 次要文字、说明文字 |
| `LabelTextColor` | 浅灰 (0.8, 0.8, 0.8) | 表单标签 |
| `HintTextColor` | 灰色 (0.6, 0.6, 0.6) | 提示文字、占位符 |
| `InputTextColor` | 黑色 (0, 0, 0) | 输入框文字 |
...
| 变量名 | 默认值 | 用途 |
|--------|--------|------|
| `CanvasBackgroundColor` | 深色 (0.08, 0.08, 0.1) | 画布背景 |
| `GridLineColor` | 深灰 (0.15, 0.15, 0.2) | 网格线 |
| `EdgeColor` | 灰色 (0.5, 0.5, 0.6) | 节点连接边线 |
| `HighlightedEdgeColor` | 绿色 (0.3, 0.8, 0.3) | 高亮/选中边线 |
...
| 变量名 | 默认值 | 用途 |
|--------|--------|------|
| `InputBackgroundColor` | 白色 (1, 1, 1) | 输入框背景 |
