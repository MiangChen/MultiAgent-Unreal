...
public:
    ...
    bool SendReviewResponse(UWorld* World, bool bApproved, const FString& DataJson, const FString& RejectionReason, const FString& OriginalMessageId) const;
    bool SendButtonEvent(UWorld* World, const FString& WidgetName, const FString& EventType, const FString& Label) const;
    FString GetTaskGraphReviewMessageId(UWorld* World) const;
    FString GetSkillAllocationReviewMessageId(UWorld* World) const;
};
