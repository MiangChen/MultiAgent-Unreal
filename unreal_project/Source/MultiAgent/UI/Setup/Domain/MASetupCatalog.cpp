#include "MASetupCatalog.h"

const TMap<FString, FString>& FMASetupCatalog::GetAvailableAgentTypes()
{
...
const TArray<FString>& FMASetupCatalog::GetAvailableScenes()
{
...
const TMap<FString, FString>& FMASetupCatalog::GetSceneToMapPaths()
{
...
TArray<FMAAgentSetupConfig> FMASetupCatalog::BuildDefaultAgentConfigs()
{
    return {
