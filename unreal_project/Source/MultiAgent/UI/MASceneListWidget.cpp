...
void UMASceneListWidget::BuildUI()
{
    ...
    BackgroundBorder->SetBrushColor(FLinearColor(0.02f, 0.02f, 0.08f, 0.9f));
    ...
    BorderSlot->SetPosition(FVector2D(10, 60));
    BorderSlot->SetSize(FVector2D(250, 0));
    ...
    GoalTitleText->SetColorAndOpacity(FSlateColor(FLinearColor(1.0f, 0.4f, 0.4f)));
    ...
    ZoneTitleText->SetColorAndOpacity(FSlateColor(FLinearColor(0.3f, 0.6f, 1.0f)));
